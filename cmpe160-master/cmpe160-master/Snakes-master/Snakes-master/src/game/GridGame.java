...
public abstract class GridGame {
    ...
    /**
     * Time variable for game speed
     */
    private Timer gameTimer;
    /**
     * Set that stores the objects that are going to be drawn
     */
     ...
     * @param drawable	An object whose class implements {@code Drawable} interface
     */
